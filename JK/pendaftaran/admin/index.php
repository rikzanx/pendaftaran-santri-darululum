...
include '../koneksi.php';
$pendaftar = mysqli_query($koneksi,"SELECT * FROM tb_pendaftar");
$pendaftar = mysqli_num_rows($pendaftar);
$formulir = mysqli_query($koneksi,"SELECT * FROM tb_formulir");
$formulir = mysqli_num_rows($formulir);
$konfirmasi = mysqli_query($koneksi,"SELECT * FROM tb_pendaftar where status='1' ");
$konfirmasi = mysqli_num_rows($konfirmasi);
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="logout.php"><i class="fa fa-"></i> Dashboard</a></li><li><a href="logout.php"><i class="fa fa-power-off"></i> Data Pendafatar</a></li><li><a href="logout.php"><i class="fa fa-power-off"></i> Data Formulir</a></li><li><a href="logout.php"><i class="fa fa-power-off"></i> Konfirmasi Pembayaran</a></li>
