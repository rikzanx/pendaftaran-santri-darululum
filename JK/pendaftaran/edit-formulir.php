...
<main class="login-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Edit Formulir Pendaftaran</div>
                    <div class="card-body">
                        <form id="formulir">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="nama" class="form-control" name="nama" value="<?php echo $data['nama']; ?>" required autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="asal_sekolah" class="form-control" name="asal_sekolah" value="<?php echo $data['asal_sekolah']; ?>" required autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="alamat" class="col-md-4 col-form-label text-md-right">Alamat</label>
                                <div class="col-md-6">
                                    <input type="text" id="alamat" class="form-control" name="alamat" value="<?php echo $data['alamat']; ?>"required autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="unit_dituju" class="col-md-4 col-form-label text-md-right">Unit Yang Dituju</label>
                                <div class="col-md-6">
                                    <input type="text" id="unit_dituju" class="form-control" name="unit_dituju" value="<?php echo $data['tujuan_sekolah']; ?>" required autofocus>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="no_telp" class="col-md-4 col-form-label text-md-right">No Hp</label>
                                <div class="col-md-6">
                                    <input type="text" id="no_telp" class="form-control" name="no_telp" value="<?php echo $data['no_telp']; ?>" required autofocus>
                                </div>
                            </div>
                    </form>
                            <div class="col-md-6 offset-md-4">
                                
                                <button type="submit" class="btn btn-primary" id="edit-submit-formulir">
                                    Simpan Formulir
                                </button>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function upload(){
            $.ajax({
                url:'aksi-edit-formulir.php',
                type: 'POST',
                dataType: 'JSON',
                data: $('#formulir').serialize(),
                success:function(responses){
                    swal("Sukses!", "Formulir berhasil diedit!", "success")
        ...
        $("#edit-submit-formulir").click(function(){
            swal({
