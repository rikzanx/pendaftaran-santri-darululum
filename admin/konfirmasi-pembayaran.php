                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <?php 
                                    $select= mysqli_query($koneksi,"SELECT * FROM tb_pendaftar where status=1");  
                                            ...
                                            if(mysqli_num_rows($select)>0)
                                            {
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><img src="<?php echo $data['bukti_bayar'] ?>"></td>
                                                        <td><button  onclick="setuju('<?php echo $data['kode_daftar']; ?>')" class="btn btn-success m-b-10 m-l-5 setuju">Setujui</button></td>
                                                    </tr>
                                                <?php
                                                }
